...
public final class AssetTransferTest {
    ...
    class InvokeCreateAssetTransaction {
        ...
        public void whenAssetDoesNotExist() {
            ...
            Payment asset = contract.CreateAsset(ctx, "asset1", "blue", 45, "Siobhán", 60);

            assertThat(asset).isEqualTo(new Payment("asset1", "blue", 45, "Siobhán", 60));
        }
    }
    ...
    class UpdateAssetTransaction {
        ...
        public void whenAssetExists() {
            ...
            Payment asset = contract.UpdateAsset(ctx, "asset1", "pink", 45, "Arturo", 600);

            assertThat(asset).isEqualTo(new Payment("asset1", "pink", 45, "Arturo", 600));
        }
