...
public final class AssetTransferTest {
     ...
     * }
     * 
     * private final class MockAssetResultsIterator implements
     ...
     * PaymentTransfer contract = new PaymentTransfer();
     ...
     * );
     * 
     * Payment asset = contract.ReadAsset(ctx, "asset1");
     * 
     * assertThat(asset).isEqualTo(new Payment("asset1", "blue", 5, "Tomoko", 300));
     * }
     * 
     * @Test
     ...
     * when(stub.getStringState("asset1")).thenReturn("");
     * 
     * Payment asset = contract.CreateAsset(ctx, "asset1", "blue", 45, "Siobhán",
     * 60);
     * 
     * assertThat(asset).isEqualTo(new Payment("asset1", "blue", 45, "Siobhán",
     * 60));
     * }
     * }
     * 
     ...
     * );
     * 
     * Payment asset = contract.UpdateAsset(ctx, "asset1", "pink", 45, "Arturo",
     * 600);
     * 
     * assertThat(asset).isEqualTo(new Payment("asset1", "pink", 45, "Arturo",
     * 600));
     * }
     * 
     * @Test
